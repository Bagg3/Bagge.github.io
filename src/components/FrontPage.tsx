  ...
  return (
    <div className="relative flex flex-col h-screen justify-center items-center">
      ...
      <div className="absolute top-96 mb-20 flex flex-col">
        <button className="bg-slate-400 text-white text-2xl font-bold py-2 px-4 rounded-full mb-10 whitespace-nowrap shadow-lg">
          Spil Offline
          {
            //<Link to="/game" className="text-white">}
          }
        </button>
        <button className="bg-slate-400 text-white text-2xl font-bold py-2 px-4 rounded-full whitespace-nowrap shadow-lg">
          Spil Online
          {
            //<Link to="/game" className="text-white">}
          }
